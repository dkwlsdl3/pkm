...
## 변형: VM 기반 Lustre HA
베어메탈 대신 VM 안에 Lustre 타깃을 두고 호스트 Pacemaker가 VM(`ocf:heartbeat:VirtualDomain`)을 failover하는 변형 구성은 별도 노트 참고: [[lustre-ha-vm-virtualdomain]].

## 관련
- [[ha-cluster-fundamentals]] · [[lustre-servicenode-failover]] · [[lustre-server-setup]] · [[el-kernel-swap-safety]] · [[selinux-confined-daemon-ocf-ra]] · [[lustre-overview]] · [[lustre-ha-vm-virtualdomain]]
