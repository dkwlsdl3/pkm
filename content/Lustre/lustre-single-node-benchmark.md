...
- **무엇인가**: 서버 1대 안에 meta/oss VM 여러 개 + OST(HDD raidz1) + Lustre client를 모두 올린 단일노드 구성의 성능·안정성 측정 방법
...
- **외부 1GbE client** = 실사용 천장 (~112 MiB/s = 1GbE 물리 한계, iperf3·과거 R760과 교차 확인)
- 두 수치를 섞으면 영업 해석이 왜곡됨 → 반드시 분리 표기
